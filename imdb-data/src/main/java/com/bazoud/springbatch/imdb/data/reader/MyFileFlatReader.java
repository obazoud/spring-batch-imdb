...
public class MyFileFlatReader<T> extends AbstractItemCountingItemStreamItemReader<T> implements
  ...
  private SkipHeaderPolicy skipHeaderPolicy;
  ...
  public void setLinesToSkip(int linesToSkip) {
    this.skipHeaderPolicy = new LimitSkipHeaderPolicy(linesToSkip);
  }

  /**
   * Set a SkipHeaderPolicy.
   *
   * @param skipHeaderPolicy
   */
  public void setSkipHeaderPolicy(SkipHeaderPolicy skipHeaderPolicy) {
    this.skipHeaderPolicy = skipHeaderPolicy;
  }
